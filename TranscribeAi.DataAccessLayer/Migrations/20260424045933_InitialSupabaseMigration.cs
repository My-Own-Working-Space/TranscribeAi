        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyMinutesUsed = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    MonthlyMinutesLimit = table.Column<int>(type: "integer", nullable: false, defaultValue: 9999),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "general"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhisperModel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "base"),
                    ...
                    ProcessingTimeSeconds = table.Column<double>(type: "double precision", nullable: false),
                    Transcript = table.Column<string>(type: "text", nullable: false, defaultValue: ""),
                    SegmentsJson = table.Column<string>(type: "jsonb", nullable: false, defaultValue: "[]"),
                    Mode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Standard"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assignee = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false, defaultValue: "Unassigned"),
                    Deadline = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false, defaultValue: "Not specified"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionItems_TranscriptionJobs_JobId",
                        column: x => x.JobId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyPoints = table.Column<string>(type: "jsonb", nullable: false, defaultValue: "[]"),
                    ...
                    ReviewPasses = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AISummaries_TranscriptionJobs_JobId",
                        column: x => x.JobId,
                        principalTable: "TranscriptionJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMessages_TranscriptionJobs_JobId",
                        column: x => x.JobId,
                        principalTable: "TranscriptionJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_actions_job",
                table: "ActionItems",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_AISummaries_JobId",
                table: "AISummaries",
                column: "JobId",
                unique: true);
